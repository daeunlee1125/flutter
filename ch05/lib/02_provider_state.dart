...
void main() {
  runApp(
    // provider 의존성 설정 : pub.dev에서 provider 의존성 검색 > 복사
    // pubspec.yaml > provider: ^6.1.5+1 추가
    ...
    return Column(
      children: [
        ...
        Row(
          ...
          children: [
            ElevatedButton(onPressed: counterProvider.increment, child: const Text('증가')),
            ElevatedButton(onPressed: counterProvider.decrement, child: const Text('감소')),
          ],
        ),
