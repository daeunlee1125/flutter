...
void main(){
  ...
  ////////////////////////////////////
  // Nullable 타입
  // 다트의 기본 변수들은 모두 Non-Nullable
  // 타입 뒤에 ? 붙여주면 Nullable이 댐~~
  ////////////////////////////////////
  String? value1 = null;
  int? value2;
  ...
  print('etc 타입 : ${etc.runtimeType}'); // 런타임에 int로 바뀐 걸 볼 수 있다!!
...
Welcome Flutter!
  ...
  String escape = "나는 생각한다. \'Dart\'는 재밌다."; // 역슬래시죵?
  print('escape 문자열 : ${escape}');
